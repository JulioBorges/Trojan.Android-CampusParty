...
namespace AndroidControl.Hacker
{
    ...
    public class Helper
    {
        private const uint _sPI_SETDESKWALLPAPER = 0x14;
        private const uint _sPIF_UPDATEINIFILE = 0x01;
        ...
        {
            SystemParametersInfo(_sPI_SETDESKWALLPAPER, 0, path, _sPIF_UPDATEINIFILE);
        }
